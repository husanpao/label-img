...
const EntityModal = ({
  ...
  return (
    <Modal title="新建实体类型" closable={false} centered footer={false} {...props}>
      <Form
        onFinish={values => {
      ...
      >
        <Item
          ...
          name="id"
          required
          rules={[{ required: true, message: '请输入「实体 ID」' }]}
        >
          <Input />
        </Item>
        <Item
          ...
          name="tag"
          required
          rules={[{ required: true, message: '请输入「实体标签名称」' }]}
        >
          <Input />
        </Item>
        <Item
          ...
          name="type"
          required
          rules={[{ required: true, message: '请选择「标注类型」' }]}
        >
          <Group>
